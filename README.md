...
designed. Please note this example uses and requires Java 8 to work..  test test test test test test[Addressbook Screenshot](addressbook_screenshot.png "Addressbook Screenshot")
